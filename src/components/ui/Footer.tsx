...
export default function Footer() {
  ...
  return (
    <footer className="mt-16 border-t-2 border-black bg-[#2F4F4F] text-white">
      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-12 md:grid-cols-3 text-center md:text-left">
        ...
        <div className="flex flex-col items-center md:items-start">
          ...
          <div className="mt-4 flex flex-col items-center md:items-start gap-2 text-white/80">
        ...
        <div className="flex flex-col items-center md:items-start">
          ...
          <form className="mt-4 flex flex-col gap-3 w-full max-w-sm">
            <input
              type="email"
              placeholder="Email address"
              className="rounded border-2 border-black px-3 py-2 text-white bg-[#2F4F4F]"
            />
