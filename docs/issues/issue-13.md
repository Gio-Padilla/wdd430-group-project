...
**Suggested Branch:** `[YOUR-INITIALS]-issue-13-login-register-pages`
...
## Checklist
- [ ] **Prerequisite:** Ensure Issues 06, 07, 12 are completed.
...
> This is a 249-line client component. Copy the full file from the reference repo: `src/app/auth/register/page.tsx`
