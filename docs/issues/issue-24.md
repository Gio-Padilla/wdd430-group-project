...
**Suggested Branch:** `[YOUR-INITIALS]-issue-24-dashboard-product-management`
...
### File 2 — `src/app/dashboard/products/DeleteProductButton.tsx`
...
### File 3 — `src/app/dashboard/products/new/page.tsx`

> This is just a suggestion so you know where to start, how to implement, feel free to adapt and change as you go

> Copy the full 96-line file from the reference repo: `src/app/dashboard/products/new/page.tsx`
...
### File 4 — `src/app/dashboard/products/[id]/edit/page.tsx`
