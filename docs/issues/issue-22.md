...
**Suggested Branch:** `[YOUR-INITIALS]-issue-22-account-page`


**Labels:** `feature`, `frontend` | **Priority:** 🟢 Medium | **Depends on:** Issues 06, 07, 14, 15

## Checklist
- [ ] **Prerequisite:** Ensure Issues 06, 07, 14, 15 are completed.
...
> This is a 270-line client component. Copy the full file from the reference repo: `src/app/account/page.tsx`
