...
**Suggested Branch:** `[YOUR-INITIALS]-issue-19-product-detail-page`
...
## Checklist
- [ ] **Prerequisite:** Ensure Issues 07, 08, 14 are completed.
- [ ] Create `src/app/shop/[slug]/page.tsx`
- [ ] Create `src/app/shop/[slug]/ProductGallery.tsx`
- [ ] Create `src/app/shop/[slug]/AddToCartButton.tsx`
- [ ] Create `src/app/shop/[slug]/ReviewSection.tsx`

## Files to Create

### File 1 — `src/app/shop/[slug]/page.tsx`

> This is just a suggestion so you know where to start, how to implement, feel free to adapt and change as you go

> This is a 252-line server component. Copy the full file from the reference repo: `src/app/shop/[slug]/page.tsx`
...
### File 2 — `src/app/shop/[slug]/ProductGallery.tsx`
...
### File 3 — `src/app/shop/[slug]/AddToCartButton.tsx`
...
### File 4 — `src/app/shop/[slug]/ReviewSection.tsx`

> This is just a suggestion so you know where to start, how to implement, feel free to adapt and change as you go

> This is a 209-line client component. Copy the full file from the reference repo: `src/app/shop/[slug]/ReviewSection.tsx`
