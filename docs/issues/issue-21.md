...
**Suggested Branch:** `[YOUR-INITIALS]-issue-21-cart-checkout-pages`


**Labels:** `feature`, `frontend` | **Priority:** 🟡 High | **Depends on:** Issues 06, 07, 15

## Checklist
- [ ] **Prerequisite:** Ensure Issues 06, 07, 15 are completed.
- [ ] Create `src/app/cart/page.tsx`
- [ ] Create `src/app/checkout/page.tsx`

## Files to Create

### File 1 — `src/app/cart/page.tsx`
...
### File 2 — `src/app/checkout/page.tsx`

> This is just a suggestion so you know where to start, how to implement, feel free to adapt and change as you go

> This is a 136-line client component. Copy the full file from the reference repo: `src/app/checkout/page.tsx`
