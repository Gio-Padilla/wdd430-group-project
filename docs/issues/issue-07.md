...
**Suggested Branch:** `[YOUR-INITIALS]-issue-07-core-ui-components`
...
## Checklist
- [ ] **Prerequisite:** Ensure Issues 04, 05 are completed.
...
- [ ] Create `src/components/ui/CloudinaryUploadButton.tsx`
...
### File 2 — `src/components/ui/LoadingSpinner.tsx`
...
### File 3 — `src/components/ui/Badge.tsx`
...
### File 4 — `src/components/ui/Breadcrumb.tsx`
...
### File 5 — `src/components/ui/EmptyState.tsx`
...
### File 7 — `src/components/ui/QuantitySelector.tsx`
...
### File 8 — `src/components/ui/CloudinaryUploadButton.tsx`
